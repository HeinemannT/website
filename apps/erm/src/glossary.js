...
export const GLOSSARY = {
  ...
  // Added after the course-wide didactic sweep (terms reviewers found recurring)
  'aleatory uncertainty': 'Irreducible randomness — the natural variability of a process — as opposed to uncertainty from lack of knowledge.',
  'epistemic uncertainty': 'Uncertainty from lack of knowledge, reducible by learning more — as opposed to irreducible (aleatory) randomness.',
  'correlation': 'How strongly two quantities move together, from −1 (opposite) through 0 (unrelated) to +1 (lockstep); the dial that governs the diversification benefit.',
  'covariance': 'The unscaled measure of how two quantities vary together — the cross-term in portfolio-risk maths.',
  'variance-covariance': 'The matrix of variances and covariances across a set of risks — the inputs to portfolio and aggregation calculations.',
  'diversification': 'Combining imperfectly-correlated risks so they partly cancel, cutting total risk without cutting expected return — until a crisis pushes correlations toward 1.',
  'volatility': 'How widely an outcome scatters around its average (its standard deviation) — the common measure of market risk.',
  'tail dependence': 'The tendency of extreme outcomes to strike together even when normal-times correlation looks modest — why diversification thins in a crisis.',
  'heavy tails': 'Distributions where extreme outcomes are far more likely than a normal (bell) curve predicts — same idea as fat tails.',
  'power law': 'A heavy-tailed pattern where rare extreme events are far more frequent than a bell curve allows.',
  'Extreme Value Theory': 'The statistics of the extremes (tails) of distributions — letting you model rare large losses directly instead of trusting a curve fitted to the calm middle.',
  'GEV': 'Generalized Extreme Value distribution — the limiting shape of block maxima (e.g. the worst loss each year) in Extreme Value Theory.',
  'GPD': 'Generalized Pareto Distribution — the limiting shape of losses exceeding a high threshold (peaks-over-threshold).',
  'peaks-over-threshold': 'An EVT method that models every loss above a high threshold to estimate the tail.',
  'block maxima': 'An EVT method that models the largest loss in each block of time (e.g. each year).',
  'tail index': 'A number for how heavy a distribution’s tail is — lower means fatter.',
  'mean-excess': 'The average loss beyond a threshold; for a heavy tail it keeps rising as the threshold rises.',
  'Student-t': 'A bell-like distribution with fatter tails than the normal — used to model crisis-prone returns.',
  'model risk': 'The risk of loss from a model being wrong or used wrongly — bad assumptions, bad data, or applying it outside the conditions it was built for.',
  'model validation': 'Independent checking that a model is conceptually sound and actually performs — via backtesting, benchmarking, and ongoing monitoring.',
  'traffic-light test': 'Basel’s backtest scoring: green (≤4 VaR exceptions in 250 days), yellow (5–9, a capital add-on), red (10+, model rejected).',
  'Kupiec test': 'A statistical check of whether a VaR model’s observed exception rate is consistent with its claimed confidence level, or too high to be luck.',
  'regime shift': 'A change in underlying conditions (calm → crisis) that makes a model calibrated on the old regime wrong.',
  'benchmarking': 'Checking a model against an independent alternative to see whether they agree.',
  'out-of-sample': 'Testing a model on data it was not fitted to — the honest test of whether it generalises.',
  'data lineage': 'The traceable path of a number from source through every transformation to the report.',
  'single source of truth': 'One authoritative, reconciled version of a data item, so different reports can’t quietly disagree.',
  'G-SIB': 'Global Systemically Important Bank — the largest banks, held to the strictest requirements.',
  'COSO ERM': 'COSO’s enterprise risk-management framework (2017): five components and twenty principles, framed around strategy and performance.',
  'ISO 31000': 'The international risk-management standard (2018): principles, a framework, and a process. Guidance, not certifiable.',
  'System 1': 'Kahneman’s fast, automatic, intuitive mode of thinking — quick, and prone to bias.',
  'System 2': 'Kahneman’s slow, effortful, deliberate mode of thinking.',
  'black swan': 'Taleb’s term for a rare, high-impact event outside normal expectations, rationalised only in hindsight.',
  'antifragility': 'Taleb’s idea of systems that gain from disorder and volatility rather than merely surviving it.',
  'RIMS Risk Maturity Model': 'A self-assessment of an ERM programme across seven attributes and five levels (Ad hoc → Leadership).',
  'stationarity': 'The assumption that a process’s statistical behaviour doesn’t change over time — often the first thing a crisis breaks.',
  'greenwashing': 'Overstating environmental or sustainability credentials — a regulatory, legal, and reputational risk.',
  'SR 26-2': 'The US Federal Reserve’s 2026 model-risk guidance, superseding SR 11-7 — more principles-based, with generative/agentic AI placed out of scope (a live debate).',
  'ESRS': 'European Sustainability Reporting Standards — the detailed disclosure standards under the EU’s CSRD.',
  'fourth-party risk': 'Risk from your suppliers’ suppliers (and beyond) — the parts of the extended enterprise you don’t directly contract with.',
  'extended enterprise': 'The full web of third parties — suppliers, vendors, outsourcers — a firm depends on beyond its own walls.',
  ...
  'EVPI': 'Expected Value of Perfect Information — the most you’d rationally pay to remove an uncertainty before deciding.',
  'law of large numbers': 'The principle that the average of many independent samples converges to the true expected value — why Monte Carlo works.',
  'Wald’s identity': 'For a random number of random terms, the mean of the total equals the mean count times the mean term: E[S] = E[N]·E[X].',
  'compound loss': 'A total loss made of a random number of individual losses (frequency × severity) — the model behind aggregate loss distributions.',
  'precautionary principle': 'Acting to avoid a plausible severe harm even without full proof of its likelihood — contrasted with a proportionate stance.',
};
