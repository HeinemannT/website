...
export default function Lesson11() {
  return (
    <LessonShell lesson={lesson} retrieval={retrieval}>
      ...
      <p className="measure">There is essentially no mathematics in this lesson, for a concrete reason: a number attached to a badly-named risk launders a guess into a fact. If “cyber: probability 12%, impact €6m” sits in your register before anyone has separated the cause from the event from the consequence, the figure looks rigorous and decides nothing, because there is no handle for a control to grip. Naming comes first precisely so the numbers, when they arrive in Part 4, have something solid to attach to.</p>
