...
function simulateYear(risks) {
  ...
  return total;
      ...
      <Rubric
        ...
        exemplar="Meridian: 14 risks, each a Bernoulli on its probability × a lognormal severity around its impact. Average year ≈ €18m (the sum of expected losses), but a long right tail runs past €50m in the years R3, R4, or R11 fire. The board budgets the mean, sizes its buffer off the 95th percentile, and tests survival against the worst case."
      />
