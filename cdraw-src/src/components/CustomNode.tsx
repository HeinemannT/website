  ...
  if (viewMode === 'simple') {
    return (
      <div className={clsx(
        ...
        >
             <div className={clsx("p-2 backdrop-blur-sm shrink-0 pointer-events-none", isLight ? "bg-black/5" : "bg-white/20")}>
                {getIcon()}
             </div>
             ...
             <div className="flex flex-col min-w-0 flex-1 relative z-10">
                <input 
                    className={clsx(
                        inputBaseStyles,
                        "font-bold text-base leading-tight tracking-tight mb-1",
                        isLight ? "text-gray-900 placeholder:text-gray-500 focus:bg-white" : "text-white placeholder:text-white/70 bg-white/20 hover:bg-white/30 border-none focus:text-gray-900 focus:bg-white"
                    )}
                    value={data.label}
                ...
                <input
                    className={clsx(
                        ...
                        "text-[10px] uppercase tracking-wider font-semibold",
                         isLight ? "text-gray-600 placeholder:text-gray-400 focus:bg-white" : "text-white/90 placeholder:text-white/60 bg-white/10 hover:bg-white/20 border-none focus:text-gray-900 focus:bg-white"
                    )}
