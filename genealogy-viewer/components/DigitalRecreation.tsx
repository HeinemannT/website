...
const DigitalRecreation: React.FC<DigitalRecreationProps> = ({ 
  ...
  return (
    <div className="w-full h-full relative bg-texture-paper">
      ...
      */}
      <div className="absolute inset-0 overflow-auto scrollbar-thin flex flex-row" dir="rtl">
        ...
        <div className="m-auto p-4 md:p-8">
            ...
            >
                ...
                <div className="absolute inset-0 pointer-events-none opacity-40 dark:opacity-10 mix-blend-multiply"
                    style={{ 
